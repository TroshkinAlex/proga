...
public class PersonStorage {
    ...
    /**
     * @param persons add people in collection
     */
    public static void addPersons(List<Person> persons) {
        PersonStorage.persons.addAll(persons);
    }

    /**
     * @param person person for remove him
     */
    ...
    /**
     * initial people collection from file
     */
...
//        String jsonFile = FileDespatcher.readFile(DEFAULT_FILE_PATH);
        ...
        try {
            persons = Parser.jsonToPersons(jsonFile).getTreeSet();
